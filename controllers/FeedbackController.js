...
router.get('/', getUser, auth(['atm', 'datm', 'ta', 'ata']), async (req, res) => { // All feedback
	try {
...
router.get('/unapproved', getUser, auth(['atm', 'datm', 'ta', 'ata']), async ({res}) => { // Get all unapproved feedback
	try {
...
router.put('/approve/:id', getUser, auth(['atm', 'datm', 'ta', 'ata']), async (req, res) => { // Approve feedback
	try {
...
router.put('/reject/:id', getUser, auth(['atm', 'datm', 'ta', 'ata']), async (req, res) => { // Reject feedback
	try {
