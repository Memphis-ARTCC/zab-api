...
router.post('/downloads', getUser, auth(['atm', 'datm', 'ta', 'ata', 'fe', 'afe']), upload.single('download'), async (req, res) => {
	try {
...
router.put('/downloads/:id', upload.single('download'), getUser, auth(['atm', 'datm', 'ta', 'ata', 'fe', 'afe']), async (req, res) => {
	try {
...
router.delete('/downloads/:id', getUser, auth(['atm', 'datm', 'ta', 'ata', 'fe', 'afe']), async (req, res) => {
	try {
...
router.post('/documents', getUser, auth(['atm', 'datm', 'ta', 'ata', 'fe', 'afe']), upload.single('download'), async (req, res) => {
	try {
...
router.put('/documents/:slug', upload.single('download'), getUser, auth(['atm', 'datm', 'ta', 'ata', 'fe', 'afe']), async (req, res) => {
	try {
...
router.delete('/documents/:id', getUser, auth(['atm', 'datm', 'ta', 'ata', 'fe', 'afe']), async (req, res) => {
	try {
